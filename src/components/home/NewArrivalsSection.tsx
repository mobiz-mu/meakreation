...
export default async function NewArrivalsSection({ products }: Props) {
    ...
    <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-7 text-[#6f5a60] sm:text-base">
          Discover the latest handmade additions by Mea Kréation — elegant new
          pieces crafted in limited batches with a refined feminine touch.
        </p>
      </div>
