...
export default async function NewArrivalsSection() {
  ...
  if (error) {
    console.error("NewArrivalsSection load error:", error);
    return null;
  }
  ...
  return (
    <section className="relative overflow-hidden bg-[#fffdfb] py-14 md:py-20">
      {/* soft premium ambient glow */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-[10%] top-10 h-28 w-28 rounded-full bg-[hsl(var(--brand-pink-light))]/18 blur-3xl" />
        <div className="absolute right-[8%] top-14 h-32 w-32 rounded-full bg-[#f4dfd1]/30 blur-3xl" />
      </div>
        ...
        <div className="mb-8 flex flex-col gap-5 md:mb-10 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-sm leading-7 text-neutral-600 md:text-[15px]">
              Discover the latest handmade additions to Mea Kréation — fresh
              pieces crafted with elegance, femininity, and limited-batch charm.
            </p>
          </div>
